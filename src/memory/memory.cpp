...
void Memory::Initialize() {
	...
	this->ptr_gta_game_state	= memory::as_relative<game_state_t*>(memory::find_pattern(this->gta5_module, _xor_("Game-State"), Patterns::Instance().pattern_gta_game_state), 7);
}

void Memory::InitializeIngame() {
