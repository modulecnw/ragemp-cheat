...
namespace ImTricks {
	...
	*/
	namespace Animations {
		...
		*/
		extern std::unordered_map<const char*, int> valuesMapInt;
		...
		*/
		extern std::unordered_map<const char*, float> valuesMapFloat;
		...
		*/
		extern std::unordered_map<const char*, ImVec2> valuesMapVec;
